...
module.exports = environment => ({
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            DIVA_BASE_MANIFEST_NAME: JSON.stringify('CH-La_pyr_SanktUrban'),
            ...
            JSON_BASE_SERVER: environment.dev
                ...
                : environment.production
                    ? JSON.stringify('//kapellmeisterbuch-api.rism.digital')        // production endpoint
                    : JSON.stringify('https://sankturban-search.altibo.club')          // staging endpoint
        }),
