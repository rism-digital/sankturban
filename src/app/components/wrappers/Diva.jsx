                ...
                .then((r) => {
                    if (!r.ok) {
                        ...
                        this.diva = new Diva(this.divaWrapper.id, {
                            ...
                            zoomLevel: this.props.zoomLevel || 0,
                        ...
                        if (this.props.onScrollHandler) {
                            ...
                            Diva.Events.subscribe('ViewerDidScroll', () => this.props.onScrollHandler(this.diva.getCurrentPageURI()));
                        }

                        if (this.props.onVisiblePageDidChange) {
                            Diva.Events.subscribe('VisiblePageDidChange', this.props.onVisiblePageDidChange)
                        }
                        ...
                        Diva.Events.subscribe('ViewerDidLoad', () => {
                            ...
                            if (this.props.onLoad) {
                                ...
                                this.props.onLoad(this.diva.getFilenames());
                            }
                        });
                    }
                })
